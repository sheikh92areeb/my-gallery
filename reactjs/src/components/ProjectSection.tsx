  ...
  return (
    <section className="bg-white py-8">
      <div className="max-w-7xl mx-auto h-full px-4">
        <h2 className="w-fit text-blue-500 text-3xl font-bold mb-6 pb-1 border-b-4 border-b-yellow-300">
          {title || (limit ? "Latest Projects" : "All Projects")}
        </h2>
            ...
            {!limit && (
                <div className="sticky top-20 bg-white flex items-center gap-4 mb-5 py-2">
                    ...
                    <h3 className="text-blue-500 text-xl font-bold">
                        {selectedCategory ? selectedCategory.toUpperCase() : "All Projects"}
                    </h3>
                </div>
            )}
            <ProjectList
